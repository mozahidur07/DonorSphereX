              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    required
                    placeholder="Search for a hospital or transplant center..."
                    className="block w-full rounded-md py-2 px-3 bg-[#c3c3c327] border-[1px] border-[#c3c3c3b0] shadow-sm focus:border-green-500 focus:ring-1 focus:ring-green-500"
                    autoComplete="off"
                  />
                  ...
                  {showHospitalDropdown && filteredHospitals.length > 0 && (
                    <div className="hospital-dropdown absolute z-10 mt-1 w-full bg-white shadow-lg max-h-60 rounded-md py-1 text-base ring-1 ring-black ring-opacity-5 overflow-auto focus:outline-none sm:text-sm">
                      {filteredHospitals.map((hospital) => (
                        <div
                          key={hospital}
                          className="cursor-pointer select-none relative py-2 pl-3 pr-9 hover:bg-green-50 hover:text-green-900"
