  ...
  useEffect(() => {
    ...
    if (savedLoginData) {
      try {
        ...
        if (decryptedData && decryptedData.expiry > Date.now()) {
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#FEE8E8] py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-lg w-full space-y-8 bg-white rounded-2xl shadow-xl p-3 md:p-8 border border-red-100 relative overflow-hidden">
        ...
        <form className="mt-8 space-y-6 relative z-10" onSubmit={handleSubmit}>
          <div className="space-y-5">
            ...
            <div className="bg-gradient-to-r from-red-50 to-red-100 rounded-lg p-3 border border-red-200 shadow-inner relative overflow-hidden">
              ...
              <h3 className="text-sm font-semibold text-gray-800 mb-2 flex items-center">
                ...
                Sign in as <span className="text-red-600 ml-1">(select your registered role)</span>
              </h3>
              
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                <div className={`relative flex items-start bg-white bg-opacity-70 p-2 rounded-lg shadow-sm border ${formData.role === 'donor' ? 'border-red-500 ring-2 ring-red-300' : 'border-red-100'} hover:border-red-300 transition-colors duration-200`}>
                  <div className="flex-shrink-0 mt-0.5">
                    <input
                      ...
                      onChange={handleChange}
                      className="h-4 w-4 text-red-600 border-gray-300 focus:ring-red-500 transition duration-150"
                    />
                  </div>
                  <div className="ml-2">
                ...
                <div className={`relative flex items-start bg-white bg-opacity-70 p-2 rounded-lg shadow-sm border ${formData.role === 'staff' ? 'border-red-500 ring-2 ring-red-300' : 'border-red-100'} hover:border-red-300 transition-colors duration-200`}>
                  <div className="flex-shrink-0 mt-0.5">
                    <input
                      id="staff-role"
                      name="role"
          ...
          <div className="flex items-center justify-between p-3 bg-white bg-opacity-70 rounded-lg border border-red-100">
            ...
            <div className="text-sm">
              <Link to="/forgot-password" className="font-medium text-red-600 hover:text-red-800 transition-colors duration-300">
          ...
          {authError && (
            <div className="bg-red-50 border-l-4 border-red-500 text-red-700 p-4 rounded-lg shadow-md relative mb-4" role="alert">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  {authError.includes("Role mismatch") && (
                    <p className="text-xs mt-1 bg-red-100 p-1 rounded">Please select the correct role to continue.</p>
                  )}
                </div>
              </div>
            </div>
          ...
          <div>
            ...
            >
              ...
              <span className="text-base font-bold tracking-wide">{loading ? 'Signing in...' : 'Sign in to Continue'}</span>
            </button>
          </div>
          ...
          <div className="flex items-center justify-center pt-4 border-t border-red-100 mt-4">
            <div className="text-sm flex items-center">
              ...
              <Link to="/signup" className="font-medium text-red-600 hover:text-red-800 transition-colors duration-300 ml-1">
                Sign up here
              </Link>
            </div>
          </div>
          ...
          <div className="text-center mt-5 space-y-1 relative">
            ...
            <div className="flex justify-center items-center space-x-2 mt-4">
              ...
              <p className="text-sm text-gray-600 font-medium">Every login brings us closer to saving more lives</p>
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-red-500" viewBox="0 0 20 20" fill="currentColor">
                <path fillRule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" clipRule="evenodd" />
              </svg>
            </div>
